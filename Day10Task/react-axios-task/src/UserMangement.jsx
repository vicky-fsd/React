...
function User() {
  ...
  const cancelEdit = () => {
    ...
    const handleEditUser = (user) => {
        // Set originalEditingUser to store the original data
        ...
        {posts.map((post) => (
          <div key={post.id} className="card">
            <div className="card-body">
              ...
              <div className="btnt">
              <button className="btn btn-warning" onClick={() => setEditingUser(post)}>Edit</button>
              <button className="btn btn-danger" onClick={() => handleDeleteUser(post.id)}>Delete</button>
              </div>
            </div>
          </div>
        ))}
